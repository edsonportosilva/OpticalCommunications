...
# ## Receptores para sistemas de comunicações ópticas
#
# ### Função de um receptor óptico
# <img src="./figuras/Rx_OOK.png" width="400">
#
# ### Receptores para sistemas de modulação de intensidade e detecção direta
...
#
# A potência do ruído de disparo corresponderá a sua variância $\sigma_{s}^{2}$. Seja $B$ a banda do receptor óptico em $\mathrm{Hz}$, $\sigma_{s}^{2}$ pode ser calculada por
#
# $$
# \begin{align}
